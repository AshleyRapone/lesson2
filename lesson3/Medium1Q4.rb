...
# << mutates the object and permantly modifies the object.
# The object ID stays the same therefore the buffer will be permantly modified.

# + is reassignment and does not mutate the object. The object ID will change.
