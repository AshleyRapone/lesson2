# In other practice problems, we have looked at how the scope of variables affects the modification of one "layer"
...
# Reassingment inside a method never changes outer scope variables
