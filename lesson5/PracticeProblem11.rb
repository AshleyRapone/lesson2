...
# including either the select or reject method, to return a new array identical in structure to the original
...
Iterate through the array and for each subarray
  -create a new array
  -Iterate through the subarray and for each array
    -
=end
